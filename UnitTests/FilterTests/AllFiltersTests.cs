...
public class AllFiltersTests
{
  ...
  [Theory]
  [InlineData("tired of sitting by her sister on the bank", "bank")]
  [InlineData("and of having nothing to do", "and having")]
  [InlineData("for killing somebody, one she fell", "killing somebody, one she fell")]
